DSP Final Project -- Christopher Morse (drb6yv)
----

All relevant code for the music identification pipeline is provided in the `main.py` file. Code for plotting figures is provided in the `plot.py` file.
